        ...
        <div>
          ...
          <Container className={classes.jumbo} fixed>
            ...
            <div className={styles.splitButtonView}>
              <div
                className={twoD ? styles.splitButtonItemActive : styles.splitButtonItem}
                onClick={() => {
              ...
              <div
                className={threeD ? styles.splitButtonItemActive : styles.splitButtonItem}
                onClick={() => {
            ...
            <div className={styles.splitButton}>
              <div
                ...
                className={matcher ? styles.splitButtonItemActive : styles.splitButtonItem}
                onClick={() => {
              ...
              <div
                className={search ? styles.splitButtonItemActive : styles.splitButtonItem}
                onClick={() => {
            ...
            <div className={styles.bottomBox}>
              <div className={styles.bottomNavigationButtons}>
                ...
                {favorites.length > 0 ? (
                  <div
                    className={styles.homeMatcherActive}
                    onClick={() => {
