...
import { resetFilter } from '../../Matcher/FilterService';
...
const RestartMatcher = ({open, setOpen}) => {
    ...
    return (
        <div className={classes.root} open={open}>
            <div className={styles.backContainer} onClick={() =>{setOpen(!open)}}>
            ...
            <div className={styles.restartMatcherWrapper}>
                ...
                <Typography className={classes.title} variant="h2">You will restart the neighborhood matcher<br/>Don't worry, we will keep your favorites<Favorite className={classes.favoriteIcon}/>!</Typography>
                <Typography className={classes.desc} variant="h5">Are you sure you want to restart the Matcher?</Typography>
                <Grid container spacing={2} className={classes.buttonsWrapper}>
                    <Grid item xs={12} sm={6}>
                        <Button className={classes.customButton} onClick={() =>{dispatch(resetNeighborhood()), dispatch(resetFilter()), Router.push("/")}}>Yes, I am sure</Button>
                    </Grid>
                    <Grid item xs={12} sm={6}>
                        <Button className={classes.customButton} onClick={() =>{setOpen(!open)}}>Cancel</Button>
                    </Grid>
                </Grid>
            </div>
